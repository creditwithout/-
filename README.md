...
- ### [More information](https://github.com/creditwithout/-/tree/main/SCHEMES/Fritzing/circuit)
...
For the national we aim to improve all of our circuit, we decide to give to the judges more interactive circuit an better explanation un the folders just to have a better understanding on everything around the project.

- ### [Cirkit designer](https://github.com/creditwithout/-/tree/main/SCHEMES/Cirkit%20Designer)
- ### [Cirkit designer cirkit public viewer](https://app.cirkitdesigner.com/project/14ea10bb-b8b8-4b1f-92cd-de119d128b88)
- ### [Fritzing](https://github.com/creditwithout/-/tree/main/SCHEMES/Fritzing)
- ### [PCB](https://github.com/creditwithout/-/tree/main/SCHEMES/PCB)
...
## Robot logic and analysis

For us, it is very important that when explaining our robot, we can use diagrams and graphs that show the actual flow of logic, programming, and all the decisions that enable our ARA Robot to execute its respective rounds. We have flowcharts that show the decisions to be followed for each round, as well as specialized diagrams of the internal decisions made by some components within the code. We also have graphs that explain the actual operation mathematically and physically, with very short standard deviations in the execution of everything.

- ### [Flowcharts](https://github.com/creditwithout/-/tree/main/robot%20logic%20and%20analysis/flowcharts)
   - #### [First Challenge](https://github.com/creditwithout/-/tree/main/robot%20logic%20and%20analysis/flowcharts/First%20challenge)
   - #### [Second Challenge](https://github.com/creditwithout/-/tree/main/robot%20logic%20and%20analysis/flowcharts/Second%20Challenge)
     
- ### [Graphics](https://github.com/creditwithout/-/tree/main/robot%20logic%20and%20analysis/graphics)

## SRC
Here you will find the two complete source codes for each round, in order to remain faithful to the engineering process, as well as detailed explanations of the most interesting and complex parts of our codes.
...
- ### [Second Challenge](https://github.com/creditwithout/-/tree/main/src/Second%20Challenge)
    - ### [Camera](https://github.com/creditwithout/-/tree/main/src/Second%20Challenge/camera)


## [Team Analysis](https://github.com/creditwithout/-/tree/main/team%20analysis)

- ### [Work team Schedule](https://github.com/creditwithout/-/tree/main/team%20analysis/Work%20Schedule)
- ### [Project cost Schedule](https://github.com/creditwithout/-/tree/main/team%20analysis/project%20cost%20analysis)
- ### [WorkFlow](https://github.com/creditwithout/-/tree/main/team%20analysis/workflow)

## Performative Videos

### `You'll find every video in` [here](https://github.com/creditwithout/-/tree/main/video)

## Media

### 'And all our social media, clash royal clan and web page in' [here](https://github.com/creditwithout/-/tree/main/media%20)
